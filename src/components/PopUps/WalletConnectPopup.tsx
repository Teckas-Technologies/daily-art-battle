    ...
    return (
        <div className="sign-in-popup fixed top-0 z-50 w-full h-full flex items-center justify-center px-3">
            <div className="signin-card w-[25.5rem] h-auto lg:p-8 md:p-6 p-4 rounded-2xl bg-black">
                ...
                <h6 className='text-center text-sm leading-tight font-light py-2'>Connect your {userDetails?.user?.nearAddress} wallet!</h6>
                <h2 className='text-green font-bold text-xl text-center pt-3 pb-4 md:px-0 px-10'>Connect the correct NEAR address</h2>
                <div className="popup-btns w-full flex justify-center items-center gap-3 py-1"> {/** mb-5 */}
                    ...
                    <div className="signin-outer w-auto rounded-3xl cursor-pointer">
                        <div className="signin-btn px-10 py-2 rounded-3xl cursor-pointer" onClick={handleSignIn}>
                            <h2>Connect</h2>
                        </div>
                    </div>
                </div>
