...
export const SignInPopup: React.FC<Props> = ({ text, onClose, infoMsg }) => {
  ...
  return (
    <div className="sign-in-popup fixed top-0 z-50 w-full h-full flex items-center justify-center px-3">
      <div className="signin-card w-[25rem] h-auto lg:p-8 md:p-6 p-4 rounded-2xl bg-black">
        ...
        <h6 className="text-center text-xs leading-tight font-light py-2">
          {infoMsg}
        </h6>
        <h2 className="text-green font-bold text-lg text-center py-3">
          {text}
        </h2>
