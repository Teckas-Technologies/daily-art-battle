        ...
        <form onSubmit={uploadArtWork}>
          ...
          {artworks.map((artwork, index) => (
            <div className="content" key={index}>
                    ...
                    {(!artwork.previewUrl || isAiGenerated) && (
                      <div className="file-outer">
                        <label
                          ...
                          className="filebtn font-semibold md:text-md text-sm md:px-[1.5rem] md:py-[0.5rem] px-[1.5rem] py-[0.4rem] cursor-pointer"
                        >
                          {artwork.name}
                        </label>
                      </div>
              ...
              {imageCreating && (
                <div className="generating w-full flex justify-center mb-3">
              ...
              <div className="generateSection">
                <button className="gfxButton md:flex hidden md:py-[0.7rem] md:px-[2.5rem] py-[0.3rem] px-[1.5rem] md:text-sm text-xs">
                  GFXvs
                </button>
                <input
                  type="text"
                ...
                />
                <button
                  className={`generateButton md:px-[1.2rem] md:py-[0.8rem] px-[1rem] py-[0.7rem] ${
                    userDetails &&
                    userDetails?.user?.gfxCoin < AI_IMAGE &&
                    "red"
                  }  ${imageCreating ? "opacity-50 cursor-not-allowed" : ""}`}
                ...
                >
                  <div>
                    <InlineSVG
                      ...
                      className="fill-current md:h-5 md:w-5 h-4 w-4"
                    />
                  </div>{" "}
          ...
          <div className="popup-bottom">
            <button
              className="cancelButton px-[2rem] py-[0.7rem]"
              onClick={onClose}
            >
              Cancel
            </button>
            <button
              className={`continueButton px-[2rem] py-[0.7rem] flex items-center gap-2 ${
                isFormValid ? "success" : ""
              }`}
