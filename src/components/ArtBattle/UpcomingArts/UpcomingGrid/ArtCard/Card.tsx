        ...
        <div className="card w-auto gap-0 md:rounded-[1.25rem] rounded-[1rem] md:mt-5 mt-0 shadow-md p-[0.5rem] flex flex-col items-center"> {/* lg:w-[18.5rem] lg:h-[26.5rem] md:w-[17rem] md:h-[25rem] w-[10rem] h-[15.5rem] */}
                ...
                <div className="absolute bottom-0 w-full flex items-center justify-between md:px-3 md:pb-2 px-2 pb-1">
                    <div className={`relative w-full flex items-center ${adminEmail === userMail ? "justify-between" : "justify-end"}`}>
                        {adminEmail === userMail &&<> <div className="hide md:w-[3rem] md:h-[3rem] w-[1.7rem] h-[1.7rem] z-40 bg-white flex justify-center items-center rounded-full cursor-pointer hover:move-like" onClick={hideArtByAdmin}>
                         ...
                         You can hide the arts uploaded by the users
                       </div></>}
            ...
            <div className="art-info w-full flex justify-between items-center md:py-2 md:px-4 py-1 px-1">
                <div className="art-owner">
                    <h2 className='collect lg:text-md md:text-sm text-xs md:spartan-semibold spartan-light md:w-[9rem] w-[4.5rem] truncate overflow-hidden whitespace-nowraps'>Collects</h2>
                </div>
